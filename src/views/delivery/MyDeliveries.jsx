...
const MyDeliveries = () => {
  ...
  const fetchMyDeliveries = async () => {
    try {
      ...
      try {
        ...
        if (statsRes.data?.success) {
          ...
          console.log(
            ...
            backendStats?.deliveredOrders
          );
          console.log("📊 recentActivity:", backendStats?.recentActivity);
          console.log(
            "📊 Does stats have delivered orders data?",
            backendStats?.deliveredOrdersData || "No"
          );
        }
      } catch (statsError) {
      ...
      const deliveredFromStats =
        backendStats?.recentActivity?.filter(
          (activity) => activity.status === "delivered"
        ) || [];

      console.log(
        "✅ Delivered from stats recentActivity:",
        deliveredFromStats.length
      );
      ...
      try {
        ...
        if (deliveredRes.data?.success) {
          ...
          const enhancedOrders = allDeliveredOrders
            .slice(0, expectedCount)
            .map((apiOrder) => {
              const statsData =
                statsDataMap[apiOrder._id] || statsDataMap[apiOrder.order];
      ...
      console.log(
        "✅ Final delivered orders for table:",
        deliveredOrdersData.length
      );
      ...
      if (allDeliveriesRes.data?.success) {
        ...
        console.log(
          "🚚 Regular deliveries (for dashboard):",
        ...
        console.log("✅ My Deliveries loaded successfully:", {
          ...
          delivered: allDeliveries.filter((d) => d.status === "delivered")
            .length,
          backendStatsUsed: !!backendStats,
        });
      } else {
        throw new Error(
          allDeliveriesRes.data?.message || "Failed to fetch deliveries"
        );
      }
    } catch (error) {
      ...
      if (error.response?.status === 401) {
        ...
        setError(
          "Access denied. You do not have permission to view deliveries."
        );
  ...
  const calculateStats = (deliveries) => {
    ...
    const rejectedDeliveries = deliveries.filter(
      (d) => d.status === "rejected"
    ).length;
  ...
  console.log(
    "📊 Real delivered orders from existing data:",
  ...
  return (
    <div className="my-deliveries container mt-2">
        ...
        <div className="col-12 col-md-8 mb-3 mb-md-0">
          ...
          <div className="d-flex align-items-center gap-2">
            <p className="text-muted mb-0">
              All your delivery history and current assignments
            </p>
            {lastUpdated && (
              <div
      ...
      <Row className={`g-3 mb-4 ${loading ? "data-refresh" : ""}`}>
        ...
        <Col md={6} xl={3}>
          <div
            className="stats-card success h-100 d-flex flex-column justify-content-between rounded shadow-sm p-3"
        ...
        <Col md={6} xl={3}>
          <div
            className="stats-card warning h-100 d-flex flex-column justify-content-between rounded shadow-sm p-3"
        ...
        <Col md={6} xl={3}>
          <div
            className="stats-card danger h-100 d-flex flex-column justify-content-between rounded shadow-sm p-3"
      ...
      <Card className="admin-card mb-4 overflow-hidden w-100">
        <Card.Header className="p-3">
          <div className="row align-items-center g-3">
            <div className="col-12 col-md-8">
              ...
              <small className="text-muted">
                Last 15 orders successfully delivered by you
              </small>
            </div>
            <div className="col-12 col-md-4 d-flex justify-content-md-end">
        ...
        <Card.Body className="p-0">
          {loading ? (
            ...
            <div
              style={{ height: "auto", maxHeight: "70vh", overflow: "hidden" }}
            >
              <iframe
                style={{
                  width: "100%",
                        ...
                        <tbody>
                          ${deliveredOrdersForTable
                            ...
                            .map((order, index) => {
                              ...
                              let customerName =
                                order.customerName || "Customer Info Needed";
          ...
          {selectedDelivery && (
            <>
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    getStatusConfig(selectedDelivery.status).color + "15",
                }}
              >
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  {selectedDelivery.order?.user?.phone && (
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `tel:${selectedDelivery.order.user.phone}`,
                          "_self"
                        )
                      }
                    >
                    ...
                    <Card.Body>
                      ...
                      <div className="mb-3">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <span>
                            {selectedDelivery.order?.user?.phone || "N/A"}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <div className="text-success fw-bold fs-5">
                          ₹
                          {selectedDelivery.order?.totalPrice?.toLocaleString() ||
                            0}
                        </div>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <div>
                          {new Date(
                            selectedDelivery.order?.createdAt ||
                        ...
                        <div className="row">
                          <div className="col-md-8">
                            <div className="mb-2">
                              ...
                              {selectedDelivery.order.shippingAddress.street}
                            </div>
                            <div className="mb-2">
                              <strong>City:</strong>{" "}
                              {selectedDelivery.order.shippingAddress.city}
                            </div>
                            <div className="mb-2">
                              <strong>State:</strong>{" "}
                              {selectedDelivery.order.shippingAddress.state}
                            </div>
                            <div className="mb-2">
                              <strong>ZIP Code:</strong>{" "}
                              {selectedDelivery.order.shippingAddress.zipCode}
                            </div>
                          </div>
              ...
              {selectedDelivery.order?.items &&
                selectedDelivery.order.items.length > 0 && (
                  <Row className="mt-4">
                    <Col md={12}>
                      <Card className="border-0 shadow-sm">
                        <Card.Header className="bg-dark text-white">
                          <div className="d-flex justify-content-between align-items-center">
                            <h6 className="mb-0">
                              <BsBoxSeam className="me-2" />
                              Order Items ({
                                selectedDelivery.order.items.length
                              }{" "}
                              items)
                            </h6>
                    ...
                    <Card.Body>
                      <div className="mb-3">
                        ...
                        <div className="mt-2">
                          <Badge
                            bg={
                              getStatusConfig(selectedDelivery.status).variant
                            }
                            className="p-2 fs-6"
                          >
                            {React.createElement(
                    ...
                    <Card.Body>
                      <div className="mb-3">
                        ...
                        <div className="mt-2">
                          <Badge
                            bg={
                              selectedDelivery.order?.paymentMethod === "card"
                                ? "primary"
                                : "warning"
                            }
                            className="p-2"
                          >
                            {selectedDelivery.order?.paymentMethod === "card"
                              ? "Card Payment"
                              : selectedDelivery.order?.paymentMethod === "cash"
                              ? "Cash on Delivery"
                              : selectedDelivery.order?.paymentMethod ||
                                "Not Specified"}
                          </Badge>
                        </div>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <div className="mt-2">
                          <Badge
                            bg={
                              selectedDelivery.order?.paymentStatus === "paid"
                                ? "success"
                                : "warning"
                            }
                            className="p-2"
                          >
                            {selectedDelivery.order?.paymentStatus === "paid"
                              ? "Paid"
                              : selectedDelivery.order?.paymentStatus ===
                                "pending"
                              ? "Pending"
                              : selectedDelivery.order?.paymentStatus ||
                                "Unknown"}
