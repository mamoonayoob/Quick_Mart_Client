            ...
            <Card className="shadow-sm">
              <Card.Header className="bg-white border-bottom">
                <div className="d-flex align-items-center">
                  <Link to="/profile" className="btn btn-outline-danger btn-sm me-3">
                    <BsArrowLeft className="me-1" />
                    Back to Profile
                  </Link>
                  <div>
                    <h4 className="mb-0 text-danger">Messages</h4>
                    <p className="text-muted mb-0">Chat with vendors, admins, and delivery personnel</p>
                  </div>
                </div>
              </Card.Header>
          ...
          <div className="d-flex flex-wrap gap-3">
              ...
              <Card className="shadow-sm" style={{ width: '200px' }}>
                <Card.Body className="d-flex align-items-center">
                  <div className="bg-light rounded-circle p-3 me-3">
                    {unreadCount > 0 ? <BsEnvelopeFill size={24} className="text-danger" /> : <BsEnvelope size={24} className="text-secondary" />}
                  </div>
                  <div>
            ...
            <Link to="/orders/history" className="text-decoration-none">
              <Card className="shadow-sm" style={{ width: '200px' }}>
                <Card.Body className="d-flex align-items-center">
                  <div className="bg-light rounded-circle p-3 me-3">
                    <i className="bi bi-box text-secondary" style={{ fontSize: '24px' }}></i>
                  </div>
                  <div>
                    <h6 className="mb-0">Orders</h6>
                    <small className="text-muted">{orders?.length || 0} total</small>
                  </div>
                </Card.Body>
              </Card>
            </Link>
            ...
            <Link to="/users/wishlist" className="text-decoration-none">
              <Card className="shadow-sm" style={{ width: '200px' }}>
                <Card.Body className="d-flex align-items-center">
                  <div className="bg-light rounded-circle p-3 me-3">
                    <i className="bi bi-heart text-secondary" style={{ fontSize: '24px' }}></i>
                  </div>
                  <div>
          ...
          <Card className="shadow-sm h-100">
            ...
            <Card.Body>
              <div className="mb-4">
                ...
                <p className="mb-0">{user?.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Customer'}</p>
              </div>
      ...
      <Card className="shadow-sm">
        <Card.Body>
          {ordersLoading ? (
            ...
            <p className="text-center py-4">You haven't placed any orders yet.</p>
          ) : (
