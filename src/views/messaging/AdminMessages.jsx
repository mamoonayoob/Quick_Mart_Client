...
const AdminMessages = () => {
  ...
  const fetchAllUsers = async () => {
    try {
      ...
      const delivery = deliveryData.success
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (selectedUser.role === "vendor") {
        endpoint =
          "https://nextgenretail.site/quickmart/api/messages/admin-to-vendor/general";
        requestBody.vendorId = selectedUser._id;
      } else if (selectedUser.role === "customer") {
        endpoint =
          "https://nextgenretail.site/quickmart/api/messages/admin-to-customer/general";
        requestBody.customerId = selectedUser._id;
      } else if (selectedUser.role === "delivery") {
        endpoint =
          "https://nextgenretail.site/quickmart/api/messages/admin-to-delivery/general";
      ...
      console.log(
        "📤 [ADMIN] Sending message to endpoint:",
        endpoint,
        requestBody
      );
