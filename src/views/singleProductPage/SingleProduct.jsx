      ...
      try {
        ...
        const productImages =
          (productData.supportImages &&
            productData.supportImages.length > 0 &&
        ...
        if (productData.category) {
          ...
          if (allProducts && allProducts.data) {
            const related = allProducts.data
              .filter(
                (p) => p.category === productData.category && p._id !== id
              )
              .slice(0, 4);
              ...
              <div className="me-3">
                {[...Array(5)].map((_, i) => (
                  <BsStarFill
                    key={i}
                    className={
                      i < (product.rating || 4) ? "text-warning" : "text-muted"
                    }
                  />
                ))}
              </div>
            ...
            <div className="stock-status mb-3">
              {product.stock > 0 ? (
                <span className="in-stock">
                  <BsCheckCircleFill className="me-1" /> In Stock (
            ...
            <div className="tab-content">
              ...
              <Card className="mb-3">
                <Card.Body>
                  ...
                  <p className="mt-2">
                    ...
                    is excellent and it arrived earlier than expected.
                  </p>
                </Card.Body>
              </Card>
              ...
              <Card className="mb-3">
                <Card.Body>
                  ...
                  <p className="mt-2">
                    Very good product. The only reason I'm not giving 5 stars is
                    because the color is slightly different from what's shown in
                    the pictures.
                  </p>
                </Card.Body>
              </Card>
