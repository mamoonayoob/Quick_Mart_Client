  ...
  const handleSendNotification = async (e) => {
    ...
    try {
      ...
      await sendNotificationToCustomer(
        ...
        notificationContent,
        'admin_notification'  // Changed type to indicate it's from admin
      );
  ...
  const handleSendBroadcast = async (e) => {
    ...
    try {
      ...
      await sendNotificationToAllCustomers(
        broadcastContent,
        'admin_announcement'  // Changed type to indicate it's from admin
      );
    ...
    <Container fluid className="py-4">
      ...
      <Row>
          ...
          <Card className="mb-4">
            ...
            <Card.Body style={{ maxHeight: '500px', overflowY: 'auto' }}>
              {loading ? (
                ...
                <Alert variant="info">No notifications sent yet.</Alert>
              ) : (
                <ListGroup variant="flush">
                  {notifications
                    .filter(notification => notification.sender && notification.sender._id === user._id)
                    .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt))
                    .map(notification => (
                      <ListGroup.Item key={notification._id} className="py-3">
                        <div className="d-flex justify-content-between align-items-center mb-1">
                          <strong>
                            To: {notification.recipient ? notification.recipient.name : 'All Customers'}
                          </strong>
        ...
        <Col md={6}>
                ...
                <Tab eventKey="broadcast" title="Broadcast to All">
                  <Form onSubmit={handleSendBroadcast}>
                    ...
                    <Alert variant="info">
                      ...
                      This message will be sent to all customers as an official announcement.
                    </Alert>
          ...
          <Card className="mt-4">
            <Card.Header className="bg-primary text-white">
              <h5 className="mb-0">Admin Notification Guidelines</h5>
            </Card.Header>
            <Card.Body>
              <ul className="mb-0">
                <li>Use notifications for important system updates and announcements</li>
                <li>Keep messages clear, concise, and professional</li>
                <li>For urgent matters, consider using both notifications and email</li>
                <li>For extended conversations, use the Messages feature instead</li>
                <li>Monitor notification read status to ensure important messages are seen</li>
              </ul>
            </Card.Body>
          </Card>
        </Col>
