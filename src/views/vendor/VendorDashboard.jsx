...
const VendorDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      console.log(
        "Vendor Dashboard: Recent orders received:",
      ...
      console.log(
        "Vendor Dashboard: Using fallback mock data due to API error"
      );
      setDashboardStats({
        totalRevenue: 42500,
        revenueChange: 12.5,
      ...
      <Row className="g-4 mb-4">
          ...
          <div className="stats-card primary">
            ...
            <div
              className={`stats-change ${
                dashboardStats.revenueChange >= 0 ? "positive" : "negative"
              }`}
            >
              ...
              <span className="text-light">
                {Math.abs(dashboardStats.revenueChange)}% from last month
              </span>
            </div>
          </div>
        </Col>
        ...
        <Col md={6} xl={3}>
          <div className="stats-card success">
            ...
            <div
              className={`stats-change ${
                dashboardStats.ordersChange >= 0 ? "positive" : "negative"
              }`}
            >
              ...
              <span className="text-light">
                {Math.abs(dashboardStats.ordersChange)}% from last month
              </span>
            </div>
          </div>
        </Col>
        ...
        <Col md={6} xl={3}>
          <div className="stats-card warning">
            ...
            <div
              className={`stats-change ${
                dashboardStats.productsChange >= 0 ? "positive" : "negative"
              }`}
            >
              ...
              <span className="text-light">
                {Math.abs(dashboardStats.productsChange)}% from last month
              </span>
            </div>
          </div>
        </Col>
